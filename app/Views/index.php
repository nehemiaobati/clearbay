...
<div class="ticker-wrap" aria-hidden="true">
  <div class="ticker-track" id="ticker">
    <div class="ticker-item">
      <div class="ticker-dot"></div>Ambulances detained 30–90 min per handover
    </div>
    <div class="ticker-item">
      <div class="ticker-dot"></div>Mbagathi Hospital — 200% daily bed occupancy
    </div>
    <div class="ticker-item">
      <div class="ticker-dot"></div>KNH receives 3,000 patients against 1,800-bed capacity
    </div>
    <div class="ticker-item">
      <div class="ticker-dot"></div>Mama Lucy serves 2.25 million people alone
    </div>
    <div class="ticker-item">
      <div class="ticker-dot"></div>No real-time ED capacity visibility for ambulance crews
    </div>
    <div class="ticker-item">
      <div class="ticker-dot"></div>4.4 million Nairobians without adequate emergency cover
    </div>
    <div class="ticker-item">
      <div class="ticker-dot"></div>Cardiac arrest outcomes worsen every minute of delay
    </div>
  ...
  <div class="container my-5">
    ...
    <div class="preview-frame card blueprint-card reveal">
      <div class="dash-header">
        ...
        <div class="dash-live">
          <div class="live-dot"></div> Live · 14:32 EAT
        </div>
      </div>
