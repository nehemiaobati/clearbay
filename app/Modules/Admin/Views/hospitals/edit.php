...
<div class="container py-5 mt-5">
  ...
  <div class="mb-4">
    <a href="<?= url_to('admin.hospitals.list') ?>" class="mono-label text-decoration-none" style="color: var(--color-brand-primary);">
  ...
  <div class="mb-4 reveal">
    ...
    <h1 class="s-title mb-0">
      <?= $isEdit ? 'Edit Hospital <span class="fst-italic text-secondary">Profile</span>' : 'Register New <span class="fst-italic text-secondary">Hospital</span>' ?>
    </h1>
  </div>
  ...
  <div class="row justify-content-start">
    <div class="col-lg-8">
      <div class="card border-secondary border-opacity-10 p-4 p-md-5" style="background: var(--color-bg-card);">
        ...
        <form action="<?= $isEdit ? url_to('admin.hospitals.update', $hospital->id) : url_to('admin.hospitals.create') ?>" method="POST">
          <?= csrf_field() ?>
          ...
          <div class="row">
            <div class="col-md-4 mb-4">
              <div class="form-floating">
                <input type="text" id="code" name="code" class="form-control bg-dark bg-opacity-25 border-secondary border-opacity-25 <?= session('errors.code') ? 'is-invalid' : '' ?>" placeholder="Facility Code" required
              ...
              <div class="small font-monospace text-secondary mt-1">e.g. KNH · Level 6</div>
            </div>
            <div class="col-md-8 mb-4">
              <div class="form-floating">
                <input type="text" id="name" name="name" class="form-control bg-dark bg-opacity-25 border-secondary border-opacity-25 <?= session('errors.name') ? 'is-invalid' : '' ?>" placeholder="Hospital Name" required
          ...
          <div class="row">
            <div class="col-md-6 mb-4">
              <div class="form-floating">
                <input type="text" id="category" name="category" class="form-control bg-dark bg-opacity-25 border-secondary border-opacity-25 <?= session('errors.category') ? 'is-invalid' : '' ?>" placeholder="Category" required
              ...
              <div class="small font-monospace text-secondary mt-1">e.g. National Referral · Public</div>
            </div>
            <div class="col-md-6 mb-4">
              <div class="form-floating">
          ...
          <details class="mb-4">
            <summary class="mono-label text-secondary py-2" style="cursor: pointer;">Capacity & Location <span class="text-secondary">(click to expand)</span></summary>
            <div class="border-top border-secondary border-opacity-10 pt-3 mt-2">
              <div class="row">
                <div class="col-md-4 mb-4">
                  <div class="form-floating">
                    <input type="number" id="bays_available" name="bays_available" class="form-control bg-dark bg-opacity-25 border-secondary border-opacity-25 <?= session('errors.bays_available') ? 'is-invalid' : '' ?>" min="0" placeholder="0"
                ...
                <div class="col-md-4 mb-4">
                  <div class="form-floating">
                    <input type="number" id="baseline_avg" name="baseline_avg" class="form-control bg-dark bg-opacity-25 border-secondary border-opacity-25 <?= session('errors.baseline_avg') ? 'is-invalid' : '' ?>" min="0" placeholder="60"
                  ...
                  <div class="small font-monospace text-secondary mt-1">Target off-load time · default 60</div>
                </div>
                <div class="col-md-4 mb-4">
                  <div class="form-floating">
                    <input type="text" id="lat" name="lat" class="form-control bg-dark bg-opacity-25 border-secondary border-opacity-25 <?= session('errors.lat') ? 'is-invalid' : '' ?>" placeholder="-1.2921"
                ...
                <div class="col-md-4 mb-4">
                  <div class="form-floating">
                    <input type="text" id="lng" name="lng" class="form-control bg-dark bg-opacity-25 border-secondary border-opacity-25 <?= session('errors.lng') ? 'is-invalid' : '' ?>" placeholder="36.8219"
              ...
              <div class="row">
                <div class="col-md-8 mb-4">
                  <div class="form-floating">
                    <input type="text" id="address" name="address" class="form-control bg-dark bg-opacity-25 border-secondary border-opacity-25 <?= session('errors.address') ? 'is-invalid' : '' ?>" placeholder="Full address"
                ...
                <div class="col-md-4 mb-4">
                  <div class="form-floating">
                    <input type="text" id="contact_phone" name="contact_phone" class="form-control bg-dark bg-opacity-25 border-secondary border-opacity-25 <?= session('errors.contact_phone') ? 'is-invalid' : '' ?>" placeholder="+254..."
          ...
          <div class="d-flex align-items-center gap-3">
            ...
            <a href="<?= url_to('admin.hospitals.list') ?>" class="btn btn-outline-secondary touch-target">
              Cancel
            </a>
          </div>
        </form>
