    ...
    <div class="col-lg-8">
      <div class="card blueprint-card p-4 p-md-5">
        ...
        <form action="<?= $isEdit ? url_to('admin.ambulances.update', $ambulance->id) : url_to('admin.ambulances.create') ?>" method="POST" class="form-dark">
          ...
          <div class="row">
            <div class="col-md-6 mb-3">
              <div class="form-floating">
                ...
                <div class="form-note mt-1 admin-form-note">e.g. KRC-401, E-Plus 22, St John 05</div>
            ...
            <div class="col-md-6 mb-3">
              <div class="form-floating">
                ...
                <div class="form-note mt-1 admin-form-note">e.g. Kenya Red Cross, E-Plus, St John Ambulance</div>
          ...
          <details class="mb-3">
            <summary class="mono-label text-muted border-bottom border-secondary border-opacity-10 pb-2 mb-3" style="cursor: pointer;">Assignment & Registration</summary>
            <div class="row">
              <div class="col-md-6 mb-3">
                <div class="form-floating">
                  <select id="ems_provider_id" name="ems_provider_id" class="form-select <?= session('errors.ems_provider_id') ? 'is-invalid' : '' ?>">
              ...
              <div class="col-md-6 mb-3">
                <div class="form-floating">
                  <input type="text" id="registration" name="registration" class="form-control <?= session('errors.registration') ? 'is-invalid' : '' ?>" placeholder="Registration Plate"
          ...
          <details class="mb-3">
            <summary class="mono-label text-muted border-bottom border-secondary border-opacity-10 pb-2 mb-3" style="cursor: pointer;">GPS Coordinates (Optional — auto-updated by device)</summary>
            <div class="row">
              <div class="col-md-6 mb-3">
                <div class="form-floating">
                  <input type="text" id="current_lat" name="current_lat" class="form-control <?= session('errors.current_lat') ? 'is-invalid' : '' ?>" placeholder="Latitude"
              ...
              <div class="col-md-6 mb-3">
                <div class="form-floating">
                  <input type="text" id="current_lng" name="current_lng" class="form-control <?= session('errors.current_lng') ? 'is-invalid' : '' ?>" placeholder="Longitude"
          ...
          <div class="d-flex align-items-center gap-3 mt-4">
            ...
            <a href="<?= url_to('admin.ambulances.list') ?>" class="btn btn-outline-secondary" style="min-height: 48px;">
              Cancel
            </a>
          </div>
        </form>
