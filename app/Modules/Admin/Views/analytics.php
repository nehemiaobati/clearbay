...
<div class="container admin-page">
  ...
  <div class="mb-4 reveal">
    <a href="<?= url_to('admin.dashboard') ?>" class="mono-label text-decoration-none admin-back">← Back to Admin Panel</a>
  </div>
  ...
  <div class="row align-items-end g-3 mb-5 reveal">
    ...
    <div class="col-md-6 text-md-end d-flex flex-column flex-sm-row gap-2 justify-content-md-end align-items-stretch align-items-md-center">
      <a href="<?= url_to('admin.analytics.export') ?>" class="btn btn-primary px-3" style="min-height: 48px;">Export Report</a>
